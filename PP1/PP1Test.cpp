...
// Example if Catch 2 is in the same directory as project and you only have one source file: 
//    g++ -std=c++17 -Wall -Icatch.hpp CalcList.cpp PP1Test.cpp 
/**************************************************************************************************/
...
TEST_CASE("Homework 1 Test Cases for CalcList") {
  CalcList calc;
